...
directory = 'E:/data/helath data/health data years divded/2018-2024'
...
temp_df['dates'] = dates
temp_df.columns = [i for i in range(len(filtered_data.columns))]
...
header.columns = [i for i in range(len(filtered_data.columns))]

# Concatenate header and data, and write to CSV file
concatenated_data = pd.concat([header, temp_df], axis=0)
output_filename = 'E:\data\helath data\health data years divded/2018-2024.csv'
